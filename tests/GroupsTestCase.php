...
use Psycho\Groups\Facades\GroupsFacade;
use Psycho\Groups\GroupsServiceProvider;
...
abstract class GroupsTestCase extends TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('psycho_groups.user_model', User::class);
        $app['config']->set('psycho_groups.big_increments', true);
    }
    ...
    {
        $users = factory('Psycho\Groups\Models\User', $count)->create();
